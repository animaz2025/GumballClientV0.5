...
public class ItemCounter extends HudElement {
    public static final HudElementInfo<ItemCounter> INFO = new HudElementInfo<>(GumballClient.HUD_GROUP, "item-counter", "Count different items in text.", ItemCounter::new);
