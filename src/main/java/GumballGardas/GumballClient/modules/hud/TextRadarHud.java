...
public class TextRadarHud extends HudElement {
    public static final HudElementInfo<TextRadarHud> INFO = new HudElementInfo<>(GumballClient.HUD_GROUP, "text-radar", "Displays players and their stats in your visual range.", TextRadarHud::new);
