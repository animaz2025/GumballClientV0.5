...
public class LavaWarning extends HudElement {
    public static final HudElementInfo<LavaWarning> INFO = new HudElementInfo<>(GumballClient.HUD_GROUP, "lava-warning", "Warns you when there is lava under you.", LavaWarning::new);
