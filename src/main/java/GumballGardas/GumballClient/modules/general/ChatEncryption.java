...
import GumballGardas.GumballClient.events.SendRawMessageEvent;
...
public class ChatEncryption extends Module {
    ...
    public ChatEncryption() {
        super(GumballClient.CATEGORY, "chat-encryption", "Encrypts your chat messages to make them unreadable to other people.");
    }
