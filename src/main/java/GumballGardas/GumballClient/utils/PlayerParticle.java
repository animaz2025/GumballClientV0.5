package GumballGardas.GumballClient.utils;
...
public class PlayerParticle {
    ...
    private static final List<UUID> LIGHTNING_UUIDS = Lists.newArrayList(UUID.fromString("408fb01f-3ac5-4fa7-aa65-9fba051c9c51"), UUID.fromString("ff8a62c2-b2d7-4334-8794-e0af3b9ad8c2"), UUID.fromString("bc48b56d-d2e2-4838-ae6d-bd26559c1267"));
