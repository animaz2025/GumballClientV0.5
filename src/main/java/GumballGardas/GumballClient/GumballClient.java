package GumballGardas.GumballClient;

import com.mojang.logging.LogUtils;
import GumballGardas.GumballClient.modules.commands.*;
import GumballGardas.GumballClient.modules.general.*;
import GumballGardas.GumballClient.modules.hud.*;
import GumballGardas.GumballClient.utils.*;
...
public class GumballClient extends MeteorAddon {
	public static final Category CATEGORY = new Category("GumballClient", Items.BLUE_DYE.getDefaultStack());
	public static final HudGroup HUD_GROUP = new HudGroup("GumballClient");
	...
	public String getPackage() {
		return "GumballGardas.GumballClient";
	}
